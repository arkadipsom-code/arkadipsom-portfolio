    ...
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-300">
      ...
      <div className="flex flex-col sm:flex-row gap-8 md:gap-12 justify-between items-start">
        ...
        <div className="space-y-1 flex-1">
          ...
          <p>Civil Engineering Undergrad | Pre-Final Year at <span className="font-bold text-black">IIEST Shibpur</span> 
          <br/>
          Focused on engineering meaningful, scalable and feasible solutions for real-world problems.
          <br />
          Interested Domains: Technology, Management Consulting, Business Analytics, Strategy and Operations.</p>
      ...
      <div className="space-y-5">
        <h3 className="text-base font-bold tracking-widest text-gray-800 uppercase">Education & Standings</h3>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-y-6 gap-x-8">
          <div>
            <div className="text-xs text-gray-500 font-bold tracking-wider uppercase">B.Tech CGPA</div>
            <div className="text-2xl font-extrabold text-black mt-1">{profileData.education.metrics.cgpa}</div>
          </div>
          <div>
            <div className="text-xs text-gray-500 font-bold tracking-wider uppercase">10th Grade</div>
            <div className="text-2xl font-extrabold text-black mt-1">{profileData.education.metrics.secondary_school}</div>
          </div>
          <div>
            <div className="text-xs text-gray-500 font-bold tracking-wider uppercase">12th Grade</div>
      ...
      <div className="space-y-4">
        <h3 className="text-base font-bold tracking-widest text-gray-800 uppercase">Core Focus</h3>
        <ul className="space-y-3">
          {profileData.objectives.map((obj, idx) => (
            <li key={idx} className="text-[14px] text-gray-700 flex items-start gap-3 leading-relaxed">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 pt-2">
        <div className="space-y-1">
          <h4 className="text-base font-bold tracking-widest text-gray-800 uppercase">Curriculum Vitae</h4>
          <p className="text-sm text-gray-500">Download compiled technical credentials and history metrics.</p>
        </div>
